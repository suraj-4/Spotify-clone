...
const LoggedInContainer = ({children}) => {
    ...
    const togglePlayPause = () => {
        if (isPause) {
            playMusic("https://res.cloudinary.com/duzlnujqa/raw/upload/v1750358604/ovdr35wboms9hhg7ealp.mp3");
            setIsPause(false);
        } else {
            pauseMusic();
            setIsPause(true);
    ...
    return (
        ...
        <main>
            ...
            <div class="authSec">
                ...
                <a href="#" class="btns btn_one">Sign up free</a>
            </div>
            )}
