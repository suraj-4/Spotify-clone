...
const HeaderComponent = () => {
    ...
    const searchSong = async ()=>{
        ...
        try {
            const response = await makeAuthenticatedGETRequest(`/song/songname/${searchText}`);
            const resultData = await response.getSong;
            if (resultData){
            ...
            <div className="header_lft">
                ...
                <div className="search_area_wrapper">
                    ...
                    <div className="search_input_wrapper">
                        ...
                        <a href="" className="icon_btn lib_icon">
                            <svg data-encore-id="icon" role="img" aria-hidden="true" className="e-9640-icon" viewBox="0 0 24 24"><path d="M15 15.5c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z"></path><path d="M1.513 9.37A1 1 0 0 1 2.291 9h19.418a1 1 0 0 1 .979 1.208l-2.339 11a1 1 0 0 1-.978.792H4.63a1 1 0 0 1-.978-.792l-2.339-11a1 1 0 0 1 .201-.837zM3.525 11l1.913 9h13.123l1.913-9H3.525zM4 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v4h-2V3H6v3H4V2z"></path></svg>
                        </a>
                    </div>
                </div>
            </div>
            <div className="header_rht">
                <div className="header_links_wrapper">
                    <div className="header_links_lft">
                        <a href="#">Premium</a>
                        <a href="#">Support</a>
                        <a href="#">Download</a>
                    </div>
                    <div className="header_links_rht">
                        <a href="#">
                            <div className="install_link">
                                <div className="small_icon">
                                    <svg data-encore-id="icon" role="img" aria-hidden="true" className="e-9640-icon" viewBox="0 0 16 16">
                        ...
                        {cookie.token ?(
                            <div className="auth_links">
                                ...
                                <Link to="/" className="username_box"><span>SD</span></Link>
                             </div>
                        ) : (
                            <div className="auth_links">
                                <Link to="/signup">Sign up</Link>
                                <Link to="/login" className="btns btn_one">Log in</Link>
                            </div>
                        )}
                    </div>
                </div>
