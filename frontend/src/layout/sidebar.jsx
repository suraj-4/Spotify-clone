...
const SidebarComponent = () => {
    ...
    return (
        <div className="sidebar_wrapper">
            ...
            <div className="sidebar_mid_wrapper" style={cookie.token ? { height: "100%" } : {}}>
                ...
                <div className="card_style_one">
                    ...
                    <a href="#" className="btns btn_two">Browse podcasts</a>
                </div>
            </div>
            {!cookie.token && (
            <div className="sidebar_bottom_wrapper">
                ...
                <a href="#" className="btns btn_three">
